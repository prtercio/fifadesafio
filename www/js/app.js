...
app.config( function( $stateProvider, $urlRouterProvider, $ionicConfigProvider ) {
  ...
  } ).state( 'app.torneiosCopa', {
    url: '/torneiosCopa',
    views: {
      'menuContent': {
        templateUrl: 'views/torneios/copa/principal.html',
        controller: 'CtrlTorneiosCopa'
      }
    }
  } ).state( 'app.torneiosMataDetalhes', {
    url: '/torneiosMataDetalhes/:torneioId',
    views: {
      'menuContent': {
        templateUrl: 'views/torneios/copa/mataDetalhes.html',
        controller: 'CtrlTorneiosMataDetalhes as idTorneioKeyUsuario'
      }
    },
    resolve: {
      idTorneioKeyUsuario: function( $stateParams ) {
