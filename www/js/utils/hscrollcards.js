( function( ionic ) {
  ...
  // CARDWIDTH = 120;
  angular.module( 'ionic.contrib.ui.hscrollcards', [ 'ionic' ] ).directive( 'hscroller', [ '$timeout', function( $timeout ) {
    return {
      restrict: 'E',
    ...
    return {
      ...
      link: function( scope, element, attrs ) {
        var img = angular.element( "<a href='" + attrs.url + "'><img class='hscroller-img' src='" + attrs.image + "' /></a>" );
        element.append( img );
