...
app.directive( 'fabButtonRight', function fabButtonDirective() {
	...
	function template( element, attr ) {
		...
		return isAnchor( attr ) ? '<a class="fab-button-right ' + cssClass + '" ng-transclude></a>' : '<button class="fab-button-right ' + cssClass + '" ng-transclude></button>';
	}
	//link
...
app.directive( 'fabButtonLeft', function fabButtonDirective() {
	...
	function template( element, attr ) {
		var cssClass = attr.cssClass ? attr.cssClass : "";
		return isAnchor( attr ) ? '<a class="fab-button-left ' + cssClass + '" ng-transclude></a>' : '<button class="fab-button-left ' + cssClass + '" ng-transclude></button>';
	}
	//link
